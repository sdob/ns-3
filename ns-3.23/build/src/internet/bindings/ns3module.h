...
public:
    ...
    { ns3::TcpTahoe::ScaleSsThresh(scaleFactor); }
...
public:
    ...
    inline void ScaleSsThresh__parent_caller(uint8_t scaleFactor)
    { ns3::TcpWestwood::ScaleSsThresh(scaleFactor); }
...
public:
    ...
    inline void ScaleSsThresh__parent_caller(uint8_t scaleFactor)
    { ns3::TcpNewReno::ScaleSsThresh(scaleFactor); }
...
public:
    ...
    inline void ScaleSsThresh__parent_caller(uint8_t scaleFactor)
    { ns3::TcpReno::ScaleSsThresh(scaleFactor); }
