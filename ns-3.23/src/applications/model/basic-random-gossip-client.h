...
#ifndef BASIC_RANDOM_GOSSIP_CLIENT_H
#define BASIC_RANDOM_GOSSIP_CLIENT_H
 ...
 * \brief A Basic Random Gossip client
 *
 * Every packet sent should be returned by the server and received here.
 */
class BasicRandomGossipClient : public Application 
{
public:
  /**
  ...
  BasicRandomGossipClient ();

  virtual ~BasicRandomGossipClient ();
   ...
   */
  // I don't want this for my gossip client
   ...
   */
  // I'm going to hack the implementation of this to always set the
  // dataSize to the size of a double
...
#endif /* BASIC_RANDOM_GOSSIP_CLIENT_H */
