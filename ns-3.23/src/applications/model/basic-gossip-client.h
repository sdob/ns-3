...
#ifndef BASIC_GOSSIP_CLIENT_H
#define BASIC_GOSSIP_CLIENT_H
...
/**
 * \ingroup basicgossip
 * \brief A Basic Gossip client
 *
 * Every packet sent should be returned by the server and received here.
 */
class BasicGossipClient : public Application 
{
public:
  /**
